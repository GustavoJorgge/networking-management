    ...
    <ProtectedRoute>
      <div className="max-w-4xl mx-auto mt-10 bg-white rounded-2xl shadow-lg p-6">
            <Button
              ...
              className="flex items-center gap-2 mb-4 text-gray-600 transition-colors"
                variant="secondary"
              ...
              <Card key={comunicado.id} className="relative hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1">
                    ...
                    <CardContent className="text-gray-600 whitespace-pre-wrap mb-4 p-0 text-base font-normal">
                      {comunicado.conteudo}
                    </CardContent>
